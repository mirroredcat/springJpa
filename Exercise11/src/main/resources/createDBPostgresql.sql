...
drop sequence companies_cono_seq;
drop sequence persons_pno_seq;
drop sequence courses_cid_seq;
drop sequence sessions_sno_seq;

create sequence companies_cono_seq start with 105;
create sequence persons_pno_seq start with 136;
create sequence courses_cid_seq start with 8057;
create sequence sessions_sno_seq start with 18;

CREATE TABLE COMPANIES
(CONO      INT  primary key default nextval('companies_cono_seq'),
...
(SNO       INT  primary key default nextval('sessions_sno_seq'),
 SDATE     DATE NOT NULL,
 SINS_PNO  INT,
 SLOC_CONO INT,
